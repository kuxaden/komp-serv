"use strict";var _require=require("browser-sync"),active=_require.active,_require2=require("engine.io-client/build/esm/util"),byteLength=_require2.byteLength;function openMenu(){document.querySelector(".menu-list").classList.toggle("active"),document.querySelector(".navbar-btn").classList.toggle("active")}function closeMenu(){document.querySelector(".menu-list").classList.toggle("active"),document.querySelector(".navbar-btn").classList.toggle("active")}function startAnimate(){document.querySelector(".about").classList.add("animated");for(var e=document.querySelectorAll(".about-block__text-item"),t=0;t<e.length;++t)e[t].classList.add("animated")}
